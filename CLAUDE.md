After we make sure that the develop  branch is up to date, 
we should have this rule:
1- Each Epic should have its own branch. 
2- Each story should be branched from the epic. 
