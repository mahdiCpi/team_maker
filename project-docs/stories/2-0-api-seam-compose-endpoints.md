...
- **No story anywhere creates the FastAPI app.** Story 4.1's AC opens *"Given the API is
  ...
  (`ARCHITECTURE-SPINE.md:210`), not because it is borrowing from Epic 4.
